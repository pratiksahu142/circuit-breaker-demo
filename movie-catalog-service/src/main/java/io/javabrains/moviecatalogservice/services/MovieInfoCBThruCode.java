...
//    FUNCTIONAL APPROACH
  ...
  public CatalogItem circuitBreaker(Rating rating) {
    ...
    CheckedFunction0<CatalogItem> infoServiceCall = CircuitBreaker.decorateCheckedSupplier(
        circuitBreaker,
        () -> getCatalogItem(
  ...
  public String bulkhead() {
    CheckedFunction0<String> infoServiceCall = Bulkhead.decorateCheckedSupplier(bulkhead,
        () -> "The movie info is" + restTemplate.getForObject(
            "http://movie-info-service/movies/110", String.class));
